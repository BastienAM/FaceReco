...
@AssociationOverrides({ @AssociationOverride(name = "id.role", joinColumns = @JoinColumn(name = "pk_fk_role_user")),
		@AssociationOverride(name = "id.right", joinColumns = @JoinColumn(name = "pk_fk_right_user")) })
